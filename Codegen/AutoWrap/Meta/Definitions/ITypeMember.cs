...
{
    /// <summary>
    /// Describes a member of a class or something in a class context. This interface is
    /// implemented by: <see cref="DefTypeMember"/>, <see cref="DefProperty"/>, 
    ...
    public interface ITypeMember
    {
        ...
        /// <see cref="CLRTypeName"/> and <see cref="NativeTypeName"/>).
        /// </summary>
        string TypeName { get; }
